      ...
      <div className="container-fluid pt-5 pb-3">
        <div className="container">
          ...
          <div className="row">
            ...
            {loading ? (
              <div className="container align-items-center justify-content-center" style={{ height: "20rem" }} >
              ...
              plans.map((item, index) => (
                <div key={index} className="col-lg-4 mb-4 ">
                  ...
                  >
                    <div
                      className={`d-inline-flex flex-column align-items-center justify-content-center ${index == 1 ? 'bg-primary' : 'bg-secondary'
