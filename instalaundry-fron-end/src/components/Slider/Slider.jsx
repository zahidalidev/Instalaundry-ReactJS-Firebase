                        ...
                        <div className="carousel-item active">
                            ...
                            <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div className="p-3" style={{ maxWidth: "900rem" }}>
                                    ...
                                    <Button onClick={() => history.push('/pricing')} style={{ backgroundColor: Colors.secondary, color: Colors.white }} className="btn btn-primary py-md-3 px-md-4 mt-2" variant="contained">GET STARTED</Button>
                                </div>
                            </div>
                        </div>
                    </div>
