        ...
        <div className="row">
          ...
          >
            <div className="d-inline-flex">
              <i
                class="fa fa-map-marker text-white m-0 mr-3"
                aria-hidden="true"
          ...
          >
            ...
            >
              <i
                className="fa fa-2x fa-envelope text-white"
                style={{ marginRight: '-2.3rem' }}
              ></i>
              <div className="d-flex flex-column">
                <h5 className="text-white font-weight-medium">Email Us</h5>
                <p className="m-0 text-white">support@instalaundry.ca</p>
              </div>
            </div>
          </div>
          <div
          ...
          >
            <div className="d-inline-flex text-left">
              <i
                class="fa fa-phone text-white m-0 mr-2"
                aria-hidden="true"
