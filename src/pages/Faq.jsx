            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  time, stress, and inconvience. We do not subcontract any work
                  to other people/companies in order to maintain our service
                  standards. Every load is individually washed with machines.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion>
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  Each hamper you provide us will be washed together under cold
                  water settings to prevent color leaks. Your clothes will never
                  be cleaned with items belonging to others. It is the customers
                  responsibliy to ensure all clothing provided in the hamper can
                  be washed together, special requests must be made through
                  customer service.
                </Typography>
              </AccordionDetails>
            </Accordion>
            ...
            <Accordion>
              ...
              <AccordionDetails>
                <Typography>
                  ...
                  Our service goal provides our customers with thier laundry in
                  12 hours. This applies to laundry pick up times in our
                  designated business timeframes. Changes to scheudled times or
                  bad weather conditions may effect turnaround.
                </Typography>
              </AccordionDetails>
            </Accordion>
            <Accordion>
